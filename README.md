...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/dlatk-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12950&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/dlatk-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `dlatk` can be installed with:

```
conda install dlatk
```

It is possible to list all of the versions of `dlatk` available on your platform with:
